...
return [
     ...
     */
    'engines'        => [
        'eloquent'   => App\DataGrid\Engines\EloquentEngine::class,
        'query'      => App\DataGrid\Engines\QueryBuilderEngine::class,
        'collection' => App\DataGrid\Engines\CollectionEngine::class,
    ],
