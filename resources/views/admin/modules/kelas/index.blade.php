...
<header class="header bg-light lter hidden-print bg-white box-shadow">
    ...
    <div class="pull-right" style="margin-top: 10px;">
        <a href="{{ route('admin.kelas.create') }}" class="btn btn-sm btn-primary" data-bjax>Create</a>
        <button class="btn btn-sm btn-success btn-refresh" data-item="refresh"><i class="icon-refresh"></i></button>
        <button class="btn btn-sm btn-danger btn-delete" data-item="delete" data-url="{{ route('admin.kelas.destroy', [0]) }}"><i class="icon-trash"></i></button>
    </div>
</header>
<section class="data-grid">
    <table id="peserta-table" data-url="{{ route('admin.kelas.data') }}"></table>
    <div id="pager"></div>
</section>
@endsection
        ...
        $(document).ready(function () {
            ...
            var grid = $('table#peserta-table').dataGrid({
                colModel: [
                    ...
                    { label: 'Kelas', name: 'nama', width: 200, searchoptions:{sopt:['eq','ne','le','lt','gt','ge']}},
                    { label: 'Jurusan', name: 'jurusan.nama', width: 200, searchoptions:{sopt:['eq','ne','le','lt','gt','ge']}},
