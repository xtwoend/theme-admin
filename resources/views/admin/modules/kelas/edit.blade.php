...
{!! Form::model($row, ['route' => ['admin.kelas.update', $row->id], 'class' => 'form', 'method' => 'PUT']) !!}

<header class="header bg-light lter hidden-print bg-white box-shadow">
    <p> <strong>Edit Data Kelas </strong></p>
    <div class="pull-right" style="margin-top: 10px;">
        <a href="{{ route('admin.kelas.index') }}"  class="btn btn-sm btn-info" data-bjax> <i class="fa fa-chevron-left"></i></a>
    ...
    <section class="bg-white-only b-r col-sm-6 no-padder form-horizontal">
        <section class="vbox animated fadeInUp">
            <section class="scrollable hover wrapper w-f">
                ...
                <h4 class="m-t-none font-thin m-b">Informasi Kelas</h4>
                ...
                <div class="form-group line-dashed b-b">
                    <label class="col-md-3 control-label  p-r-none">Jurusan <span>:</span></label>
                    <div class="col-md-9  p-l-none">
                        {!! Form::select('jurusan_id', App\Entities\Jurusan::pluck('nama', 'id') , null, ['class' => 'form-control no-border', 'placeholder' => 'Jurusan...']) !!}
                    </div>
                </div>
