...
<header class="header bg-light lter hidden-print bg-white box-shadow">
    <p> <strong>Data Jurusan </strong></p>
    <div class="pull-right" style="margin-top: 10px;">
        <a href="{{ route('admin.jurusan.create') }}" class="btn btn-sm btn-primary" data-bjax>Create</a>
        <button class="btn btn-sm btn-success btn-refresh" data-item="refresh"><i class="icon-refresh"></i></button>
        <button class="btn btn-sm btn-danger btn-delete" data-item="delete" data-url="{{ route('admin.jurusan.destroy', [0]) }}"><i class="icon-trash"></i></button>
    </div>
</header>
<section class="data-grid">
    <table id="peserta-table" data-url="{{ route('admin.jurusan.data') }}"></table>
    <div id="pager"></div>
</section>
@endsection
