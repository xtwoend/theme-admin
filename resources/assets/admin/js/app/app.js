...
+function ($) {
  ...
  $(function(){
    ...
    $(document).on('click', '.printarea', function(e){
      e && e.preventDefault();
      var pagePrint = $(this).attr('data-print');
      var win = window.frames[pagePrint];
      win.focus();
      win.print();
    });

    $('textarea[data-item="editor"]').each(function(){
      $.trumbowyg.svgPath = '/images/icons.svg';
      let upload_url = $(this).data('upload') || '/media/upload';
      $(this).trumbowyg({
          autogrow: true,
    ...
    $(document).on('click', 'textarea[data-item="editor"]', function(e){
      $.trumbowyg.svgPath = '/images/icons.svg';
      let upload_url = $(this).data('upload') || '/media/upload';
      $(this).trumbowyg({
          autogrow: true,
    ...
    $(document).on('click', 'button[data-action="ajax"]', function(e){
      // e && e.preventDefault();
